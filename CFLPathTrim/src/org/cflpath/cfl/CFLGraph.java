...
public class CFLGraph {
	...
	public int getIdByElement(String element) {
		return this.elementFactory.getIdByElement(element);
	}
	
	private int add(String vertex) {
		int vertexId = this.vertexFactory.getIdByElement(vertex);
		this.vertices.add(vertexId);
		if(this.weights.get(vertexId) == null) {
	...
	public class GraphElement {
		...
		public String toString() {
			return elementFactory.getElementById(this.element) + "(" + vertexFactory.getElementById(this.source) + "," + vertexFactory.getElementById(this.sink) + ")"; 
		}
